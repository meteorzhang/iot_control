package app.iot.widget.tab.buildins.commonnavigator;
...
import app.iot.R;
import app.iot.widget.tab.NavigatorHelper;
import app.iot.widget.tab.ScrollState;
...
import app.iot.widget.tab.buildins.commonnavigator.abs.IMeasurablePagerTitleView;
...
import app.iot.widget.tab.buildins.commonnavigator.model.PositionData;
...
public class CommonNavigator extends FrameLayout implements IPagerNavigator, NavigatorHelper.OnNavigatorScrollListener {
    ...
    private void init() {
        ...
        View root;
        if (mAdjustMode) {
            root = LayoutInflater.from(getContext()).inflate(R.layout.layout_pager_navigator_no_scroll, this);
        } else {
            root = LayoutInflater.from(getContext()).inflate(R.layout.layout_pager_navigator, this);
        }
